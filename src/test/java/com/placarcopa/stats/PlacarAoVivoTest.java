...
class PlacarAoVivoTest {
    ...
    void deveProjetarPlacarAPartirDosEventos() {
        PlacarAoVivo placar = PlacarAoVivo.inicial(mensagem(TipoEvento.MATCH_STARTED, "0", 1, Map.of()))
                ...
                .aplicar(mensagem(TipoEvento.MATCH_ENDED, "90", 6, Map.of()));

        assertThat(placar.golsTeamA()).isEqualTo(1);   // gol do England
        assertThat(placar.golsTeamB()).isEqualTo(1);   // gol contra do England
        ...
        assertThat(placar.ultimaSequence()).isEqualTo(6);
    }
